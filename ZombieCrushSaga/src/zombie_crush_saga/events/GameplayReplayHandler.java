 ...
 */
public class GameplayReplayHandler implements ActionListener
{
     ...
     */
    public GameplayReplayHandler(ZombieCrushSagaMiniGame initGame)
    {
        miniGame = initGame;
    }
    ...
    public void actionPerformed(ActionEvent ae)
    {
        ...
        if (miniGame.isCurrentScreenState(GAMEPLAY_SCREEN_STATE) )
        {
            ...
            if(!data.hasMovingZombies()){
                // reload the level's set data, like moves.
